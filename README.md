...
**kristal-object-selector-plus** 是一个面向 Kristal 开发期的场景对象编辑器，让你直接在游戏里摆放物品。
...
| ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| [v0.11.0-dev](https://github.com/KristalTeam/Kristal/commit/8e592d84065263138d4e92593f0a4ab780d93822) (`8e592d8`, 2026-09-21) | 0.2.1                          |
